...
export function Thread() {
  ...
  return (
    <div className="flex w-full h-screen overflow-hidden">
      ...
      >
        {!chatStarted && (
          <div className="absolute top-0 left-0 w-full flex items-center justify-between gap-3 p-2 pl-4 pr-2 z-10">
            <div>
        ...
        {chatStarted && (
          <div className="flex items-center justify-between gap-3 p-2 z-10 relative">
            <div className="flex items-center justify-start gap-2 relative">
              ...
              >
                <LogoSVG width={26} height={26} className="translate-y-0.5"/>
              ...
              <div className="sticky flex flex-col items-center gap-8 bottom-0 bg-white">
                {!chatStarted && (
                  <div className="flex gap-1 items-center">
                    <LogoSVG className="flex-shrink-0 h-8 translate-y-0.5" width={32} height={32} />
